...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->energypoints > 0)
	{
		...
		std::cout << "ClapTrap " << this->name << " be Repaired: " << amount  << ". " << this->hitpoints << " Points of hp!" << std::endl;
		this->energypoints--;
	}
	else
...
{
	this->hitpoints -= amount;
	std::cout << "ClapTrap " << this->name << " take " << amount << " Damage.  " << this->hitpoints << " points of hp!" << std::endl;
}
